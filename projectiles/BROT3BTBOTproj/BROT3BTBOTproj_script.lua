...
local AeonBROT3BTBOTproj = import('/lua/BlackOpsprojectiles.lua').AeonBROT3BTBOTproj
...
BROT3BTBOTproj = Class(AeonBROT3BTBOTproj) {
    ...
    OnImpact = function(self, TargetType, TargetEntity) 
        ...
        local ChildProjectileBP = '/projectiles/BROT3BTBOT2proj/BROT3BTBOT2proj_proj.bp'  
