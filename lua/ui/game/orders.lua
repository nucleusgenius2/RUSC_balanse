...
---@param self any
---@param modifiers EventModifiers
local function TeleOrderBehavior(self, modifiers)
    if modifiers.Left then
        StandardOrderBehavior(self, modifiers)
    elseif modifiers.Right then
        local modeData = {
            name="RULEUCC_Script",
            AbilityName='ScatterTele',
            TaskName='ScatterTele',
            cursor = 'RULEUCC_Teleport',
        }
...
local defaultOrdersTable = {
    ...
    RULEUCC_Teleport = {            helpText = "teleport",          bitmapId = 'teleport',              preferredSlot = 10, behavior = TeleOrderBehavior},
