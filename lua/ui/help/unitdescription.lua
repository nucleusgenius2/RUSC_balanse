...
Description = {
  ...
  ['uel0001-uoch1'] = "<LOC Unit_Description_00161> Changes the parameters of the overcharge\nMaximum damage 1000\nRate of fire - once every 5 seconds",
  ['uel0001-uoch2'] = "<LOC Unit_Description_00171> Changes the parameters of the overcharge\nMaximum damage 3000\nRate of fire - once every 5 seconds",
  ...
  ['uel03011'] = "<LOC Unit_Description_0016> A multi-purpose construction, repair, capture and reclamation unit. Equivalent to a Tech 3 Engineer. ",
  ['uel03011-rj'] = "<LOC Unit_Description_0020> Radar Jammer creates false radar images. Countered by Omni sensors.",
  ['uel03011-hamc'] = "<LOC Unit_Description_00223> Adds the shoulder module of the high explosive gun.",
  ['uel03011-dsu'] = "<LOC Unit_Description_00224> Adds SACU's repair nanosystem.",
  ['uel03011-tm'] = "<LOC Unit_Description_0004> Mounts a tactical cruise missile launcher onto the back of the SACU.",
  ['uel03011-atl'] = "<LOC Unit_Description_01141>  Equips the SACU with a standard Cybran Nanite torpedo tube and sonar.",
  ['uel03011-ed'] = "<LOC Unit_Description_0017> Engineering Drone acts as a secondary Engineer. Assists the SACU where applicable.",
  ['uel03011-sre'] = "<LOC Unit_Description_0022> Greatly expands the range of the standard on-board SACU sensor systems.",
  ['uel03011-hpsq'] = "<LOC Unit_Description_00221> Adds an air defense installation to the back, the damage is equal to 2 ordinary t3 air defense installations.",
  ...
  ['uel03011_Torpedo'] = "<LOC uel03011_Torpedo_help> Support Armored Command Unit. Enhanced during construction with a Resource Allocation System.",
  ['uel03011_Rambo'] = "<LOC uel03011_Torpedo_help> Support Armored Command Unit. Enhanced during construction with a Resource Allocation System.",
  ...
  ['uese0001-exrgec'] = "<LOC Unit_Description_00181> Adds an orbital satellite laser module with damage of 243 per second",
  ['uese0001-exrgec1'] = "<LOC Unit_Description_00182> Adds an orbital satellite laser module with damage of 486 per second",
  ...
  ['url0001-coch1'] = "<LOC Unit_Description_00161> Changes the parameters of the overcharge\nMaximum damage 1000\nRate of fire - once every 5 seconds",
  ['url0001-coch2'] = "<LOC Unit_Description_00171> Changes the parameters of the overcharge\nMaximum damage 3000\nRate of fire - once every 5 seconds",
  ...
  ['ual0001-aoch1'] = "<LOC Unit_Description_00161> Changes the parameters of the overcharge\nMaximum damage 1000\nRate of fire - once every 5 seconds",
  ['ual0001-aoch2'] = "<LOC Unit_Description_00171> Changes the parameters of the overcharge\nMaximum damage 3000\nRate of fire - once every 5 seconds",
  ...
  ['ual0405-ss'] = "<LOC Unit_Description_01751> Adds the installation of anti-tactical missiles with a radius of 31.",
  ['ual0405-skry'] = "<LOC Unit_Description_01752> Adds Rihanna's eye.",
  ['ual0405-ess'] = "<LOC Unit_Description_01753> Adds antiteleport field around unit.",
  ...
  ['bab2404'] = "<LOC Unit_Description_02931> High-end power generator. Construct next to other structures for adjacency bonus.",
  ...
  ['xsl0001-pqt1'] = "<LOC Unit_Description_01421> Adds teleporter. Requires considerable Energy to activate.",
  ...
  ['xsl0001-soch1'] = "<LOC Unit_Description_00161> Changes the parameters of the overcharge\nMaximum damage 1000\nRate of fire - once every 5 seconds",
  ['xsl0001-soch2'] = "<LOC Unit_Description_00171> Changes the parameters of the overcharge\nMaximum damage 3000\nRate of fire - once every 5 seconds",
  ...
  ['xsl0301-pqt1'] = "<LOC Unit_Description_01439> Adds teleporter. Requires considerable Energy to activate.",
  ['xsl0301-oc'] = "<LOC Unit_Description_0440> Single shot destroys most units. Consumes large amount of Energy.",
  ['xsl0333-sre'] = "<LOC Unit_Description_0436> Greatly expands the range of the standard on-board SACU sensor systems, including Omni.",
  ['xsl0333-dss'] = "<LOC Unit_Description_0435> Increases the speed at which the SACU repairs itself. Also increases hit points.",
  ['xsl0333-tmu'] = "<LOC Unit_Description_0434> Mounts a tactical cruise missile launcher onto the back of the SACU.",
  ['xsl0333-efm'] = "<LOC Unit_Description_0437> Speeds up all engineering-related functions.",
  ['xsl0333-cba'] = "<LOC Unit_Description_04371> Significantly increases the damage, radius and splash of the main SAKU weapon.",
  ['xsl03331-sre'] = "<LOC Unit_Description_0436> Greatly expands the range of the standard on-board SACU sensor systems, including Omni.",
  ['xsl03331-dss'] = "<LOC Unit_Description_0435> Increases the speed at which the SACU repairs itself. Also increases hit points.",
  ['xsl03331-tmu'] = "<LOC Unit_Description_0434> Mounts a tactical cruise missile launcher onto the back of the SACU.",
  ['xsl03331-efm'] = "<LOC Unit_Description_0437> Speeds up all engineering-related functions.",
  ['xsl03331-cba'] = "<LOC Unit_Description_04371> Significantly increases the damage, radius and splash of the main SAKU weapon.",
  ['xsl033311-sre'] = "<LOC Unit_Description_0436> Greatly expands the range of the standard on-board SACU sensor systems, including Omni.",
  ['xsl033311-dss'] = "<LOC Unit_Description_0435> Increases the speed at which the SACU repairs itself. Also increases hit points.",
  ['xsl033311-tmu'] = "<LOC Unit_Description_0434> Mounts a tactical cruise missile launcher onto the back of the SACU.",
  ...
  ['xsl0333_Rambo'] = "<LOC xsl0333_Rambo_help> Support Armored Command Unit. Enhanced during construction with the personal shield generator, nano-repair system and overcharge enhancements.",
  ['xsl03331_Rambo'] = "<LOC xsl03331_Rambo_help> Support Armored Command Unit. Enhanced during construction with the personal shield generator, nano-repair system and overcharge enhancements.",
  ['xsl033311_Rambo'] = "<LOC xsl033311_Rambo_help> Support Armored Command Unit. Enhanced during construction with the personal shield generator, nano-repair system and overcharge enhancements.",
  ...
  ['bel0402'] = "<LOC bel0402_help>Designed to destroy experimental units of a similar class. This bot will win 1 on 1 battles with any other experimental bot. But not very effective against clusters of small units. ",
  ['seb0401'] = "<LOC seb0401_help>Build an experimental ACPB rembo. These AKPBs have improved armour and greater firepower. ",
  ['ura0402'] = "<LOC ura0402_help>Allows for the covert transport of large numbers of units. Has a cloaking generator that is only illuminated by the omnisensors, allowing you to covertly transport an entire army into enemy territory. The vehicle's increased armor makes it a tough target for air defenses. ",
  ['uel03011'] = "<LOC uel03011_help>Designed to reinforce advancing troops. The Mobile Shield greatly increases the potential of ground units, allowing them to penetrate echeloned fortifications or win battles against other experimental units.",
  ['ualew0002'] = "<LOC ualew0002_help>Designed to reinforce advancing troops. The Mobile Shield greatly increases the potential of ground units, allowing them to penetrate echeloned fortifications or win battles against other experimental units.",
  ['uaaew0004'] = "<LOC uaaew0004_help>Designed to fight airborne targets. Fires projectiles, has a large firing range and reliably suppresses enemy air forces.",
  ['brpt3shbm'] = "<LOC brpt3shbm_help>Designed for sabotage on the enemy's base. It has a teleportation module with an unlimited radius. In a direct collision, it is inferior to experimental units of its class.",
  ['har0002'] = "<LOC har0002_help>Creates a zone forbidden for teleportation. Enemy units with a teleportation module will not be able to teleport to this radius.",
  ['har0004'] = "<LOC har0004_help>Creates a zone forbidden for teleportation. Enemy units with a teleportation module will not be able to teleport to this radius.",
  ['har0007'] = "<LOC har0007_help>Creates a zone forbidden for teleportation. Enemy units with a teleportation module will not be able to teleport to this radius.",
  ['har0010'] = "<LOC har0010_help>Creates a zone forbidden for teleportation. Enemy units with a teleportation module will not be able to teleport to this radius.",
  ['ssb5401'] = "<LOC ssb5401_help>Designed for instant transfer of troops to the desired area. Can teleport ground units and aerial experimental units. Each gate can establish a connection with any other gate.",
  ...
  ['xss1501'] = "<LOC unit_description_xss1501>Opens the construction of heavy T3 units.",
  ['broat3pride'] = "<LOC unit_description_broat3pride>Deals tremendous damage when fired. It has an air defense system in the forest.",
