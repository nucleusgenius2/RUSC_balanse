...
OverchargeWeapon = ClassWeapon(DefaultProjectileWeapon) {
    ...
    PauseOvercharge = function(self)
        ...
        if not unit:IsOverchargePaused() then
			...
			if unit:HasEnhancement('Overcharge1') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['Overcharge1'].NewRateOfFire1)
			elseif unit:HasEnhancement('Overcharge2') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['Overcharge1'].NewRateOfFire1)
			elseif unit:HasEnhancement('RateOfFire') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['RateOfFire'].NewRateOfFire1)
			elseif unit:HasEnhancement('HeatSink') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['HeatSink'].NewRateOfFire1)
			elseif unit:HasEnhancement('HeavyAntiMatterCannon') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['HeavyAntiMatterCannon'].NewRateOfFire1)
			elseif unit:HasEnhancement('CoolingUpgrade') then
				WaitSeconds(1 / unit.Blueprint.Enhancements['CoolingUpgrade'].NewRateOfFire1)
			else
    ...
    OnEnableWeapon = function(self)
		...
		if unit:GetBlueprint().BlueprintId ~= 'xsl033311' then
			if unit:GetBlueprint().BlueprintId ~= 'xsl033311_rambo' then
