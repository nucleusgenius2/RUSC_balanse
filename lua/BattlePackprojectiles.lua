...
local TMavaEffectTemplate = import('/lua/TMavaEffectTemplates.lua')

EmtBpPath = '/effects/emitters/'
ModEmitterPath = '/effects/emitters/'
...
ODisintegratorLaserProjectile = Class(MultiPolyTrailProjectile) {
    PolyTrails = {
		'/effects/emitters/EXPCannon_polytrail_04_emit.bp',
		'/effects/emitters/EXPCannon_polytrail_05_emit.bp',
		'/effects/emitters/EXPCannon_polytrail_03_emit.bp',
	},
...
StingerMissile = Class(MultiPolyTrailProjectile) {
    FxTrails = {'/effects/emitters/air_move_trail_beam_03_emit.bp',},
    FxTrailOffset = 1,
...
FxTrails = {
	'/effects/emitters/plasmaprojectile_trail_03_emit.bp',
        '/effects/emitters/NapalmDistort.bp',
	},
...
Flamethrower = Class(EmitterProjectile) {
    ...
    FxTrails = {
        '/effects/emitters/NapalmTrailFX.bp',
        '/effects/emitters/NapalmDistort.bp',
    },
...
StarAdderMissiles = Class(MultiPolyTrailProjectile) {
    	FxTrails  = {
            '/effects/emitters/w_u_gau03_p_03_brightglow_emit.bp',
            '/effects/emitters/w_u_gau03_p_04_smoke_emit.bp',
			'/effects/emitters/missile_sam_munition_trail_01_emit.bp',
	},
	FxTrailOffset = 0.2,
	PolyTrails  = {
            '/effects/emitters/w_u_gau03_p_01_polytrails_emit.bp',
            '/effects/emitters/w_u_gau03_p_02_polytrails_emit.bp',
	},
...
FusionMissile = Class(StagedMissile) {
    ...
    BeamName = '/effects/Emitters/nomad_rocket_exhaust_beam_01.bp',
