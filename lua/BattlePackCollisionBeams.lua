...
TMNovaCatBlueLaserBeam = Class(SCCollisionBeam) {
    ...
    FxBeam = {'/effects/emitters/novacat_bluelaser_emit.bp'},
...
TMNovaCatGreenLaserBeam = Class(SCCollisionBeam) {
    ...
    FxBeamStartPoint = EffectTemplate.SDFExperimentalPhasonProjMuzzleFlash,
    FxBeam = {'/effects/emitters/novacat_greenlaser_emit.bp'},
...
SeraphimPhasonLaserCollisionBeam = Class(SCCollisionBeam) {
    ...
    FxBeam = {'/effects/emitters/alienphason_beam_01_emit.bp'},
    FxBeamEndPoint = EffectTemplate.APhasonLaserImpact01,
    SplatTexture = 'czar_mark01_albedo',
    ScorchSplatDropTime = 0.25,
...
ZapperCollisionBeam02 = Class(SCCollisionBeam) {
    FxBeam = {
	    '/effects/emitters/w_u_am01_p_02_polytrails_emit.bp',
    },
    FxBeamEndPoint = {
		'/effects/emitters/w_u_am01_i_u_01_flash_emit.bp',
		'/effects/emitters/w_u_am01_i_u_02_largeflash_emit.bp',
		'/effects/emitters/w_u_am01_i_u_03_shockwave_emit.bp',
		'/effects/emitters/w_u_am01_i_u_04_sparks_emit.bp',
		'/effects/emitters/w_u_am01_i_u_05_smoke_emit.bp',
		'/effects/emitters/w_u_am01_i_u_06_debris_emit.bp',
		'/effects/emitters/w_u_am01_i_u_07_spikeflash_emit.bp',
    },
}
...
SC2CollosusCollisionBeam = Class(SCCollisionBeam) {
    FxBeamStartPoint = EffectTemplate.APhasonLaserMuzzle01,
    FxBeam = {
		'/effects/emitters/w_i_bem01_p_01_beam_emit.bp',
    },
    FxBeamEndPoint = {     	
		'/effects/emitters/w_i_bem01_i_u_01_groundflash_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_02_flash_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_03_sparks_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_04_plasma_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_06_plasmasmoke_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_07_ring_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_08_topflash_emit.bp',
    },
...
SC2ACUCollisionBeam = Class(SCCollisionBeam) {
    FxBeamStartPoint = EffectTemplate.APhasonLaserMuzzle01,
    FxBeam = {
		'/effects/emitters/w_i_bem02_p_01_beam_emit.bp',
    },
    FxBeamEndPoint = {     	
		'/effects/emitters/w_i_bem01_i_u_01_groundflash_emit.bp',
		'/effects/emitters/w_i_bem01_i_u_02_flash_emit.bp',
