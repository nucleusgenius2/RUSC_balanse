...
-- Custom Files --
local BattlePackEffectTemplate = import('/lua/BattlePackEffectTemplates.lua')
local BattlePackBeamFile = import('/lua/BattlePackCollisionBeams.lua')
...
EXCEMPArrayBeam01 = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.EXCEMPArrayBeam01CollisionBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
...
EXCEMPArrayBeam02 = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.EXCEMPArrayBeam02CollisionBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
...
SeraphimPhasonLaser = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.SeraphimPhasonLaserCollisionBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
    FxUpackingChargeEffects = EffectTemplate.CMicrowaveLaserCharge01,
...
ExWifeMaincannonWeapon01 = Class(DefaultProjectileWeapon) {
    FxChargeMuzzleFlash = {
		'/effects/emitters/ExWifeMaincannon_muzzle_charge_01_emit.bp',
		'/effects/emitters/ExWifeMaincannon_muzzle_charge_02_emit.bp',
        '/effects/emitters/ExWifeMaincannon_muzzle_charge_05_emit.bp',
    },
    FxMuzzleFlash = {
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_01_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_02_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_03_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_04_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_05_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_06_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_07_emit.bp',
		'/effects/emitters/ExWifeMaincannon_cannon_muzzle_08_emit.bp',
		'/effects/emitters/ExWifeMaincannon_hit_10_emit.bp',
		'/effects/emitters/ExWifeMaincannon_muzzle_flash_01_emit.bp',
		'/effects/emitters/ExWifeMaincannon_muzzle_flash_02_emit.bp',
		'/effects/emitters/ExWifeMaincannon_muzzle_flash_03_emit.bp',
	},
	FxMuzzleFlashScale = 3,
	FxChargeMuzzleFlashScale = 5,
}

AdaptorZapperWeapon = Class(DefaultBeamWeapon) {
...
ZapperCollisionBeam02 = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.ZapperCollisionBeam02,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
...
TDFAlternatePlasmaCannonWeapon = Class(DefaultProjectileWeapon) {
...
TMAnovacatbluelaserweapon = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.TMNovaCatBlueLaserBeam,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
    FxUpackingChargeEffects = EffectTemplate.CMicrowaveLaserCharge01,
    FxUpackingChargeEffectScale = 1,
...
TMAnovacatgreenlaserweapon = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.TMNovaCatGreenLaserBeam,
    FxMuzzleFlash = {},
...
TWZapperWeapon = Class(DefaultBeamWeapon) {
...
UDisruptorArtillery01 = Class(DefaultProjectileWeapon) {
    FxMuzzleFlash = BattlePackEffectTemplate.UDisruptorArtillery01MuzzleFlash,
}

AAMicrowaveLaserGenerator = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.AAMicrowaveLaserCollisionBeam01,
    FxMuzzleFlash = {},
    FxChargeMuzzleFlash = {},
    FxUpackingChargeEffects = EffectTemplate.CMicrowaveLaserCharge01,
    FxUpackingChargeEffectScale = 1,
...
SC2ZephyrCannonWeapon = Class(DefaultProjectileWeapon) {
	FxMuzzleFlash = BattlePackEffectTemplate.SC2ACUMuzzleFlash,
...
StarAdderLaser = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.StarAdderLaserCollisionBeam02,
...
WyvernLaserWeapon = Class(DefaultBeamWeapon) {
    BeamType = BattlePackBeamFile.WyvernLaserWeaponCollisionBeam,
