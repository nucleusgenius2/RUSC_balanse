-----------------------------------------------------------------
-- File     :  /data/units/BSB43091/BSB4309_script.lua
    ...
    AntiteleportEffects = function(self)
        ...
        for k, v in self.AntiTeleport do
            table.insert(self.AntiTeleportBag,
                CreateAttachedEmitter(self, 'Light02', self:GetArmy(), v):ScaleEmitter(0.5):OffsetEmitter(0, -0.5, 0))
        end
        if self.AntiTeleportOrbsBag then
            for k, v in self.AntiTeleportOrbsBag do
                v:Destroy()
        ...
        for k, v in self.AntiTeleportOrbs do
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb01', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb01', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb01', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb04', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb04', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb04', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb06', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb06', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb06', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb03', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb03', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb03', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb07', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb07', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb07', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb05', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0, 0.3))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb05', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, -0.2, 0))
            table.insert(self.AntiTeleportOrbsBag,
                CreateAttachedEmitter(self, 'Orb05', self:GetArmy(), v):ScaleEmitter(0.2):OffsetEmitter(0, 0.2, 0))
        end
    end,
    ...
    antiteleportEmitter = function(self)
        if not self.Dead then
            ...
            if not self.Dead then
                ...
                local antiteleportEmitter = CreateUnit('bsb0003', self:GetArmy(), location[1], location[2], location[3],
                ...
                antiteleportEmitter:SetParent(self, 'bsb43091')
