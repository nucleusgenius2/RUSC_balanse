...
XSL03331 = Class( CommandUnit ) {
	Weapons = {
        ...
        Electrobolter01 = ClassWeapon(SDFUltraChromaticBeamGenerator) {
        	OnCreate = function(self)
              SDFUltraChromaticBeamGenerator.OnCreate(self)
    ...
    OnCreate = function(self)
        local bp = self.Blueprint.Defense.Shield
    ...
    CreateEnhancement = function(self, enh)
        ...
        --    wep1:AddDamageMod(bp.OverchargeDamageMod)
        --    wep2:AddDamageMod(bp.OverchargeDamageMod)
        ...
        --    wep:AddDamageMod(-self.Blueprint.Enhancements['Overcharge1'].AdditionalDamage)
        --    wep:AddDamageRadiusMod(-self.Blueprint.Enhancements['Overcharge1'].NewDamageRadius) 
        --    wep1:AddDamageMod(bp.OverchargeDamageMod)
        --    wep2:AddDamageMod(bp.OverchargeDamageMod)
