...
HAR0002 = Class(TRadarUnit) {
    ...
    AntiteleportEffects = function(self)
        ...
        for k, v in self.AntiTeleportEffects do
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect01', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect02', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect03', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect04', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect05', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect06', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect07', self:GetArmy(), v):ScaleEmitter(0.3))
            table.insert(self.AntiTeleportEffectsBag,
                CreateAttachedEmitter(self, 'Effect08', self:GetArmy(), v):ScaleEmitter(0.3))
        end
        if self.AmbientEffectsBag then
            for k, v in self.AmbientEffectsBag do
                v:Destroy()
        ...
        for k, v in self.AmbientEffects do
            table.insert(self.AmbientEffectsBag,
                CreateAttachedEmitter(self, 'XAB4309', self:GetArmy(), v):ScaleEmitter(0.4))
        end
    end,
    ...
    antiteleportEmitter = function(self)
        ...
        if not self.Dead then
            ...
            if not self.Dead then
                ...
                local antiteleportEmitter = CreateUnit('bab0003', self:GetArmy(), location[1], location[2], location[3],
                ...
                antiteleportEmitter:SetParent(self, 'har0002')
