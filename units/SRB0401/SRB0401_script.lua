...
local DiscountComponent = import("/lua/defaultcomponents.lua").DiscountComponent
--------------------------------------------------------------------------------
local EffectTemplate = import('/lua/EffectTemplates.lua')
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
SRB0401 = Class(CLandFactoryUnit, DiscountComponent) {
    --------------------------------------------------------------------------------
    -- Function triggers
    --------------------------------------------------------------------------------
    ...
    OnStopBeingBuilt = function(self, builder, layer)
        DiscountComponent.OnStopBeingBuilt(self, builder, layer)
    ...
    OnStartBuild = function(self, unitBeingBuilt, order)
        DiscountComponent.OnStartBuild(self, unitBeingBuilt, order)
        CLandFactoryUnit.OnStartBuild(self, unitBeingBuilt, order)
    end,

    OnStopBuild = function(self, unitBeingBuilt)
        DiscountComponent.OnStopBuild(self, unitBeingBuilt)
    ...
    CreateBuildEffects = function(self, unitBeingBuilt, order)
        ...
        if math.max(UnitSize[1], UnitSize[3]) > 3 and math.max(UnitSize[1], UnitSize[3]) <= 10 and
            math.abs(UnitSize[1] - UnitSize[3]) <= 2 then
