...
GoldLaserBombEffectController01 = Class(NullShell) {
    NukeInnerRingDamage = 800,
    NukeInnerRingRadius = 3 * 2.5,
    NukeInnerRingTicks = 1,
    NukeInnerRingTotalTime = 0,
    NukeOuterRingDamage = 1500,
    NukeOuterRingRadius = 5 * 2.5,
    ...
    MainBlast = function( self, army )
        ...
        for k, v in BlackOpsEffectTemplate.GoldLaserBombDetonate01 do
            emit = CreateEmitterAtEntity(self,army,v):ScaleEmitter(0.2*2.5)
        end
